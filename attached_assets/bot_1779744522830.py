...
# ============================================================
# CONFIGURAÇÃO — preencha esses valores
# ============================================================
TELEGRAM_TOKEN = "8750680347:AAHTCoEJh8K2wmwcX43sL1bT-oTbrqJzUJw"
OPENAI_API_KEY = "REDACTED_OPENAI_KEY"

ALLOWED_USER_IDS = [
    123456789,   # substitua pelo seu ID
    987654321,   # ID de outro funcionário autorizado
]
# ============================================================
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        response = client.chat.completions.create(
            model="gpt-4o-mini",   # barato e muito capaz
            max_tokens=1500,
            messages=messages
        )
